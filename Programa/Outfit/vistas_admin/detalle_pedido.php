...
<body>
  ...
  $productos_pedido = "SELECT pr.*, dp.cantidad 
  FROM detalle_pedido dp 
  JOIN productos pr ON dp.id_producto = pr.id_producto 
  WHERE dp.id_pedido = $idp";

  $resultado_productos = mysqli_query($conexion, $productos_pedido);
            ...
            <div class="card recent-sales overflow-auto">
              ...
              <div class="card-body">
                ...
                <table class="table table-borderless table-hover">
                  ...
                  <tbody>
                    <?php while ($filas = mysqli_fetch_assoc($resultado_productos)) { ?>
                      <tr>
                        <th scope="row" class="py-2 "><?php echo $filas['id_producto'] ?></th>
                        <td><?php echo $filas['nombre'] ?></td>
                        <td><?php echo $filas['talla'] ?></td>
                        <td><?php echo $filas['cantidad'] ?></td>
                        <td><img src="../<?php echo $filas['imagenF'] ?>" alt="Imagen del producto" class="img-fluid" style="max-width: 100px;"></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
